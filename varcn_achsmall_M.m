...
% clear;
% 
% M1=0.0001:0.001:0.5;  %膜面积单位是um^2
% M2=0.5:0.5:500;
% M=[M1,M2];
% M=M;
% N=10;  %channel个数
...
%   
% end
% save varcn_achsamll_M_1010 M DU
% 
%%%%%%%%%%N固定，随M的变化DN_cn
load('varcn_achsamll_M_550.mat')
 plot(M,DU,'b');hold on 
load('varcn_achsamll_M_1010.mat')
plot(M,DU,'r');hold on 
load('varcn_achsamll_M_1050.mat')
plot(M,DU,'r');hold on 
load('varcn_achsamll_M_2050.mat')
plot(M,DU,'b');hold on 
