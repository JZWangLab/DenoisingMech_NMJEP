...
save varwn_exachN_2050 N DUN DU
% plot(N,DUN,'k');hold on 
% plot(N,DU,'k--');hold on 


%%%%%%%%%%%%%%%%%%% M固定，随N变化的D_wn
load('varwn_exachN_201.mat')
plot(N,DUN,'k');hold on 
plot(N,DU,'k--');hold on 
load('varwn_exachN_1030.mat')
plot(N,DUN,'b');hold on 
load('varwn_exachN_2050.mat')
plot(N,DUN,'r');hold on 
load('varwn_exachN_10100.mat')
plot(N,DUN,'b');hold on 
