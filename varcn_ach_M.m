...
%   
% end
% save varcn_ach_1010 M DU DUN

%%%%%%%%%%%%N固定，随M的变化DN_cn
load('varcn_ach_150.mat')
 plot(M,DU,'b');hold on 
load('varcn_ach_1050.mat')
plot(M,DU,'r');hold on 
load('varcn_ach_2050.mat')
plot(M,DU,'b');hold on 
load('varcn_ach_1010.mat')
plot(M,DU,'r');hold on 
%load('varcn_ach_10100.mat')
%plot(M,DU,'r');hold on 
x=2000:3000;
plot(x,0.5e+1*1./(x.^2),'k--')
